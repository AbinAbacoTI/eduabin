export default function Footer () {
  return (
          <div className="bg-black px-4 py-9 md:px-6 md:py-12 lg:px-20 lg:py-12">
              <div className="flex flex-col md:flex-row md:justify-center pb-10">
              ...
              <div className="pt-10 flex flex-col xl:flex-row justify-between">
                  <div className="flex flex-col md:gap-10">
                      ...
                      <div className="flex items-start w-full">
                          ...
                          <div className="2xl:pl-20 md:pl-16 md:block hidden">
                              <h3 className="text-xl cursor-default font-semibold leading-tight text-white pb-8">About</h3>
              ...
              <div className="pt-10 lg:pt-24 flex justify-center md:justify-center gap-12">
              <div className="flex justify-start gap-4">
                  ...
                  <a href="https://www.facebook.com/EDUABIN" className="text-sm leading-relaxed text-gray-300">EDUABIN</a>
                </div>
