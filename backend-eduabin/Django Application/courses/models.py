...
class Course(models.Model):
    ...
    author = models.ForeignKey(settings.AUTH_TEACHER_MODEL, on_delete=models.CASCADE)   # Autor del Curso
...
class Question(models.Model):
    user = models.ForeignKey(settings.AUTH_STUDENT_MODEL, on_delete=models.CASCADE) # Usuario que hizo la pregunta 
...
class Comment(models.Model):
    user = models.ForeignKey(settings.AUTH_STUDENT_MODEL, on_delete=models.CASCADE) # Usuario que hizo el comentario
