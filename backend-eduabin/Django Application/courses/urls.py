...
urlpatterns = [
    ...
    path('addCategory/', CrudCategory.as_view()),                # Vista de agregar Categoría
    path('addCategory/<category_uuid>', CrudCategory.as_view()), # Vista de agregar categoria
    path('addSector/<uuid:category_uuid>/', AddSector.as_view()),# Vista de agregar Sector
    path('addSector/<sector_uuid>/', AddSector.as_view()),
    path('addSector/', AddSector.as_view()),
