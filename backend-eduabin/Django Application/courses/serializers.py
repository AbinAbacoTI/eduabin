...
class CourseDisplaySerializer(ModelSerializer):
    ...
    author = TeacherSerializer()                                            # Autor del Curso(Extraido del Serializer del Profesor)
...
class CommentSerializer(ModelSerializer):
    ...
    user=StudentSerializer(read_only=True)  # Usuario(Extraido del Serializer "StudentSerializer")
...
class CourseUnpaidSerializer(ModelSerializer):
    ...
    author=TeacherSerializer()                                          # Profesor
...
class CartItemSerializer(ModelSerializer):
    # Campos adicionales para renderizar/Serializar
    author=StudentSerializer()                                          # Estudiante
